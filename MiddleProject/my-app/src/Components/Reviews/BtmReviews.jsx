  ...
  const reviewsStr = [
    {
      name: "עינב ועופרי",
      discripion:
        "נדב היקר וכל צוות חוה ואדם! התחתנו ב16.6.16 בחתונת טבע במושב תלמי אלעזר. אנחנו רוצים לפרגן ולומר המון המון תודה על אירוע מ-ו-ש-ל-ם שחלק משמעותי מאוד ממנו הוא בזכותכם. תודה רבה על שירות אדיב, מענה אנושי ומקצועיות שאין כמותה! מומלץ בחום רב!!! עינת ועפרי :) ",
      image:
